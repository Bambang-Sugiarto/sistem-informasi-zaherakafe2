        ...
        <div class="table-responsive">
          <table class="table align-items-center table-flush text-center">
            ...
            <tbody>
              <?php
              include "koneksi.php";
              $query = "SELECT nama, tanggal, nohp,jml_lagu, harga,status, (harga * jml_lagu) AS total FROM tb_karaoke WHERE status='Menunggu'";
                ...
                <tr>
                  ...
                  <?php
                    ...
                    <?php if($_SESSION['level'] == 'user' ):?>
                      <a href="hapus.php?id_karaoke=<?= $data2['id']; ?>" onclick="return confirm('Apakah anda yakin?');"><span class="btn btn-sm btn-danger mt-1">Batal</span></a>
                      <?php endif; ?>
