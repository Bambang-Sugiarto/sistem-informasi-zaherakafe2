    ...
    <div class="col-xl-12 col-lg-11 mb-4">
      ...
      <div class="card">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primary">Daftar Makanan</h6>
        </div>
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td><img src="upload/<?= $row['gmb_makanan']; ?>" style="width: 100px; height: 100px;" alt=""></td>
                  <td>
                    <a href="hapus.php?id_mkn=<?= $row['id']; ?>" onclick="return confirm('Apakah anda yakin?');">
                      <span class="btn mt-1 btn-sm mb-1 btn-danger">Hapus</span></a>
                    <a href="edit_makanan.php?id=<?= $row['id']; ?>">
