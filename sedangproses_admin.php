...
<div class="container-fluid" id="container-wrapper">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Sedang Proses</h1>
  </div>
        ...
        <div class="table-responsive">
          <table class="table align-items-center table-flush text-center">
            ...
            <tbody>
              ...
              $query = "SELECT nama, tanggal, nohp, nama_makanan, harga_makanan, jml_makanan, nama_minuman, harga_makanan,
              ...
              while ($data = mysqli_fetch_array($sql)) { ?>
                ...
                <tr>
                  ...
                  <td>
                    <?php
                    $query2 = "SELECT id FROM tb_pesanan WHERE status='Menunggu' AND nohp = '$data[nohp]'";
                    $sql2 = mysqli_query($koneksi, $query2);
                    while ($data2 = mysqli_fetch_array($sql2)) { ?>
                    <?php if($_SESSION['level'] == 'user' ):?>
                      <a href="hapus.php?id_onproses=<?= $data2['id']; ?>" onclick="return confirm('Apakah anda yakin?');"><span class="btn btn-sm btn-danger mt-1">Batal</span></a>
                    <?php endif; ?>
                    <?php if($_SESSION['level'] == 'admin' ):?>
                      <a href="hapus.php?id_onproses=<?= $data2['id']; ?>" onclick="return confirm('Apakah anda yakin?');"><span class="btn btn-sm btn-danger mt-1">Hapus</span></a>
